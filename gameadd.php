    ...
    <div class="col-xs-6">
      ...
      <form id='gameadd' action='<?php echo $site->GetSelfScript(); ?>' method='post' accept-charset='UTF-8'>
				...
				<div class="form-group">
					...
					<input type="number" id="price" name="price" min="0.00" step="0.01" max="2500" value ="<?php echo $site->SafeDisplay('price') ?>" class="form-control" placeholder="e.g. 69.99" required autofocus autocomplete>
				</div>
        <div class="form-group">
